  ...
  return (
    <div className="flex items-center justify-between p-5 font-inter text-white">
      ...
      <div>
        ...
        <ul
          className={`${isOpen ? "-translate-x-0" : "-translate-x-full"} absolute right-0 top-0 z-30 flex h-screen w-screen flex-col items-center gap-5 overflow-hidden bg-white/65 pt-28 backdrop-blur-md backdrop:blur-xl`}
        >
