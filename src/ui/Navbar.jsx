...
function Navbar() {
  ...
  return (
    <div className="mx-auto flex items-center justify-between px-5 py-5 text-white sm:px-10 md:w-fit md:justify-center md:gap-5 md:rounded-full md:bg-[rgba(255,255,255,0.15)] md:py-2 md:backdrop-blur-3xl lg:max-w-6xl">
