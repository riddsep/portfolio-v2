  ...
  return (
    <div className="relative flex items-center justify-between p-5 font-inter text-white">
      ...
      <div className="relative">
        ...
        <ul
          className={`${isOpen ? "-translate-x-0" : "-translate-x-full"} absolute right-0 z-30 -mr-5 flex h-dvh w-screen flex-col items-center gap-5 bg-white/65 py-5 backdrop-blur-md backdrop:blur-xl`}
        >
