    ...
    <div className="bg-dust">
      <div className="flex flex-col gap-5 px-5 py-10 text-white sm:px-10 md:flex-row md:py-16 lg:mx-auto lg:max-w-6xl xl:px-0">
        <div className="max-w-[300px] lg:max-w-[600px]">
          ...
          <p
            className="mb-4 md:mb-6 md:text-xl"
            data-aos="fade-right"
            data-aos-delay="200"
          >
        ...
        <div
          className="relative mx-auto max-w-96 after:absolute after:-left-52 after:bottom-14 after:hidden after:content-[url('/arrow-2.svg')] lg:after:inline-block"
          data-aos="fade-left"
          data-aos-delay="200"
        >
          <div className="relative before:absolute before:-right-32 before:top-4 before:hidden before:-rotate-12 before:overflow-hidden before:content-[url('/arrow.svg')] lg:before:inline-block">
